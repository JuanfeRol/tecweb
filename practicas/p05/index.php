...
<body>
    ...
    <p>
        <?php
            ...
            echo $_myvar . '<br/>';
            echo $_7myvar . '<br/>';
            echo 'myvar no es una variable válida porque no empieza con $<br/>';
            echo $myvar . '<br/>';
            echo $var7 . '<br/>';
            echo $_element1 . '<br/>';
            echo '$house*5 no es una variable válida porque contiene un carácter no permitido (*).<br/>';
        ?>
    </p>
    <h2>Ejercicio 2</h2>
    <p>
        <?php
            ...
            echo 'Se modificaron los valores de a y b directamente, al ser c definido por referencia a la variable "a", su valor también se modifica';
        ?>
    </p>
    <h2>Ejercicio 3</h2>
    <p>
